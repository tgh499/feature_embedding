...
def get_normalized_mapping(perplexity):
    mapping_filename = "mapping_original_" + str(perplexity) + ".csv"
...
for perplexity in perplexities:
    index_filename = "rearranged_ecl_" + str(perplexity) + ".csv"
    ...
    print(data_features_np.shape)
    output_filename = "test_quantized_ecl_hungarian_" + str(perplexity) + ".csv"

    new_dataset = []
    for i in range(len(data_features_np)):
        temp_new_sample = []
        sample_patches = generate_patches(data_features_np[i]) # also gets converted to binary
